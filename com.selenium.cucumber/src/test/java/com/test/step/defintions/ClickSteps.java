...
/**
 * This class contains methods to allow you to click on an element More steps
 * examples here:
...
public class ClickSteps {
	...
	@When("^the user click on element having (.+) \"(.*?)\"$")
	...
	@When("^the user double click on element having (.+) \"(.*?)\"$")
	...
	@When("^the user click on link having text \"(.*?)\"$")
	...
	@When("^the user click on link having partial text \"(.*?)\"$")
