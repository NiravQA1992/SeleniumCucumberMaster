...
/**
 * This class contains methods to allow you navigate on the browser More steps
 * examples here:
...
public class NavigationSteps {
	...
	@When("^the user switch to previous window$")
	...
	@When("^the user switch to window having title \"(.*?)\"$")
	...
	/** Resize browser */
	@And("^the user resize browser window size to width (\\d+) and height (\\d+)$")
	...
	@And("^the user maximize browser window$")
	...
	/** Zoom out the page */
	@And("^the user zoom out the page$")
	public void zoomOut() {
		log.info("Zoom out");
	...
	@And("^the user set the zoom of the page to the 100%$")
	...
	@And("^the user zoom in until I see the element having (.+) \"(.*?)\"$")
	...
	@And("^the user zoom out page till I see element having (.+) \"(.*?)\"$")
	...
	@And("^the user scroll to (top|end) of page$")
	...
	@And("^the user scroll to element having (.+) \"(.*?)\"$")
