...
/**
 * This class contains methods to allow you to use keyboard methods More steps
 * examples here:
...
public class KeyboardSteps {
	...
	/** Press Key */
	@When("^the user release the keyboard key (.+)$")
	...
	/** Press Key */
	@When("^the user press and release the keyboard key (.+)$")
	...
	@When("^the user move the mouse over an element having (.+) \"(.*?)\"$")
	...
	@When("^the user move the mouse out of an element having (.+) \"(.*?)\"$")
