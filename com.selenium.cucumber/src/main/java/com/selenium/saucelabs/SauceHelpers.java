...
public class SauceHelpers {
	 ...
	 * If SauceConnect tunnel in use and not directed not to use it will use the SC
	 * command relay.
	 *
	...
	public static String buildSauceUri(boolean doNotUseSauceConnectCmdRelay) {
		...
		if (!doNotUseSauceConnectCmdRelay && seleniumPort != null
			...
			/********
			 * While running in CI, if Sauce Connect is running the SELENIUM_PORT env var
			 * will be set. use SC relay port
			 ********/
